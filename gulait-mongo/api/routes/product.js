    ...
    try {
        if( !res.headersSent ){
            ...
            if( product ){
                ...
                if( req.body.variations ) product.variations = req.body.variations;
                ...
                return res.status( 401 ).json( { 
                    message: 'Error', 
                    data: 'No product exists with the provided id. Please check the id you provided and try again' 
                } );
            }
        }
    } catch ( err ) {
